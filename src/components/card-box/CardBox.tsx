...
export default class CardBox extends Component<CardBoxProps, CardBoxState> {
  ...
  render () {
    ...
    switch (displayStyle) {
      ...
      case 'editable': {
        const itemSelected = gridModel?.getSelectData()?.[rowIndex]?.selected || false
        // console.log('xxxxx rowIndex: ', rowIndex, ' itemSelected: ', itemSelected, ' data: ', gridModel?.getSelectData());
